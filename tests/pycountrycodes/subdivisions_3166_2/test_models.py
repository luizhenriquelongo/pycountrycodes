...
from pycountrycodes.countries_3166_1 import models as countries_models
from pycountrycodes.subdivisions_3166_2 import models
...
class TestSubdivisionsClass:
    ...
    def test_search_method_raises_when_no_searchable_fields(self, subdivisions, mocker: pytest_mock.MockerFixture):
        mocked_dataclass = mocker.patch("pycountrycodes.Subdivisions.dataclass", mocker.Mock())
